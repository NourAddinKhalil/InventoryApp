CREATE TABLE [dbo].[User_Profile_Property] (
    ...
    CONSTRAINT [FK_User_Profile_Property_Profile_Prope_Name] FOREIGN KEY ([Profile_ID]) REFERENCES [dbo].[Profile_Prope_Name] ([ID]) ON DELETE CASCADE ON UPDATE CASCADE
);
