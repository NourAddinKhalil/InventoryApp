CREATE TABLE [dbo].[Screen_Roles_Detail] (
    ...
    CONSTRAINT [FK_Screen_Roles_Detail_Screen_Roles_Name] FOREIGN KEY ([Screen_Role_ID]) REFERENCES [dbo].[Screen_Roles_Name] ([ID]) ON DELETE CASCADE ON UPDATE CASCADE
);
