CREATE TABLE [dbo].[Invoice_Details] (
    ...
    CONSTRAINT [FK_Invoice_Details_Invoice] FOREIGN KEY ([Invoice_ID]) REFERENCES [dbo].[Invoice] ([ID]) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT [FK_Invoice_Details_Invoice_Details] FOREIGN KEY ([Source_Back_Row_ID]) REFERENCES [dbo].[Invoice_Details] ([ID]),
    CONSTRAINT [FK_Invoice_Details_Product] FOREIGN KEY ([Product_ID]) REFERENCES [dbo].[Product] ([ID]) ON UPDATE CASCADE,
